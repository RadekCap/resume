    ...
    <>
      {!isHome && (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50">
          <Link
            to="/"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900/90 backdrop-blur-sm text-white rounded-full border border-gray-700 hover:border-purple-500 transition-all hover:scale-105 shadow-lg hover:shadow-purple-500/50"
          >
