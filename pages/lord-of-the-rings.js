...
const RESUME_DATA = {
  header: {
    name: "RADOSLAV THE WISE",
    title: "LORD WARDEN OF THE CLUSTERS",
    location: "THE CZECH REALMS",
    summary: "A Ranger of the Code with 20 winters of service. I have journeyed from the lowlands of C++ to the peaks of the Cloud. Now, I stand watch at the Red Citadel, keeping the dark bugs at bay."
  },
  skills: [
    { name: "One Cluster to Rule Them All (K8s)", level: 95, icon: <Crown size={16} /> },
    { name: "The OpenShift Strategy", level: 90, icon: <Compass size={16} /> },
    { name: "Lore of the Red Hat", level: 92, icon: <BookOpen size={16} /> },
    { name: "Sorcery of Azure", level: 85, icon: <Sparkles size={16} /> },
    { name: "Elvish Tongue (C#)", level: 88, icon: <Scroll size={16} /> },
    { name: "Fellowship Tactics (Agile)", level: 90, icon: <Map size={16} /> }
  ],
  quests: [
    {
      year: "THE FOURTH AGE (2025)",
      role: "The White Wizard (Senior SQE)",
      location: "THE RED CITADEL (Red Hat)",
      desc: "Master of Advanced Cluster Management. I gaze into the Palantír to monitor the health of the realms. Ensuring the structural integrity of the production barriers.",
      icon: <Castle className="w-8 h-8 text-red-900" />,
      type: "major"
    },
    {
      year: "2023 - 2025",
      role: "Guardian of the Source",
      location: "MINES OF JAVA (OpenJDK)",
      desc: "Delving deep into the legacy code. Mending the ancient runestones of the Runtime and battling the Balrogs of memory leaks.",
      icon: <Gem className="w-8 h-8 text-amber-700" />,
      type: "minor"
    },
    {
      year: "2019 - 2023",
      role: "Crossing the Anduin",
      location: "THE NEW ALLIANCE",
      desc: "A pivotal journey from the lands of .NET to the open plains of Linux. Swearing fealty to the Red Hat and learning the ways of the Container.",
      icon: <Mountain className="w-8 h-8 text-stone-700" />,
      type: "pivotal"
    },
    {
      year: "2016 - 2018",
      role: "Watcher of the Skies",
      location: "SPIRE OF KENTICO",
      desc: "DevOps Specialist. Keeping watch on the Azure horizon. Weaving spells of automation to deploy the legions of code.",
      icon: <Sparkles className="w-8 h-8 text-blue-800" />,
      type: "minor"
    },
    {
      year: "2013 - 2015",
      role: "Captain of the Company",
      location: "THE FELLOWSHIP (iDoklad)",
      desc: "Scrum Master. Leading the fellowship through the marshes of spaghetti code. Ensuring the velocity of the party remains true.",
    ...
    },
    {
      ...
      desc: "A humble beginning in Alchemy (Chemistry), forging the first rings of C++. Setting out on the long road of software engineering.",
